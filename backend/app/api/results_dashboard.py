...
@router.get("/classification_confidence")
...
@router.get("/classification_accuracy")
...
@router.get("/document_stats", response_model=List[DocumentStats])
...
@router.get("/field_data", response_model=List[FieldData])
...
@router.get("/extractions/field-stats/", response_model=List[FieldStats])
